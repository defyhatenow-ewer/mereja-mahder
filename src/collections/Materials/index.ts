...
export const Materials: CollectionConfig<'materials'> = {
  slug: 'materials',
  access: {
  ...
  // This config controls what's populated by default when a material is referenced
  // https://payloadcms.com/docs/queries/select#defaultpopulate-collection-config-property
  // Type safe if the collection slug generic is passed to `CollectionConfig` - `CollectionConfig<'materials'>
  // defaultPopulate: {
  //   title: true,
  //   slug: true,
  //   categories: true,
